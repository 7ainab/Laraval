<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddFaculty.aspx.cs" Inherits="CollegeProject.AddFaculty" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Label" BackColor="#c0c0c0" ForeColor="#ffffff" Font-Size="30px" Width="1250px">Add New Faculty</asp:Label>
            ...
            <asp:Table ID="Table1" runat="server" Height="309px" Width="434px" BackColor="">
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <asp:TextBox ID="TextBoxFID"  class="form-control" OnTextChanged="TextBoxMemId_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
