<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditBooking.aspx.cs" Inherits="CollegeProject.EditBooking" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <asp:Table ID="Table1" runat="server" Height="309px" Width="434px" BackColor="">
                <asp:TableRow>
                    <asp:TableCell>
                         <asp:HiddenField ID="hdBkid" runat="server" />
                        <asp:Label ID="Label14" runat="server" Text="Room Number"></asp:Label></asp:TableCell>
                    <asp:TableCell>
                        <asp:TextBox class="form-control" ID="txtRoomNum" runat="server"  OnTextChanged="TextBoxRoomNum_TextChanged" AutoPostBack="true"></asp:TextBox>
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:TableCell>
                            ...
                            <asp:TextBox ID="txtMemId" class="form-control" OnTextChanged="TextBoxMemId_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox><asp:Label ID="lblMsg" ForeColor="Green" runat="server" Text=""></asp:Label>
                            <asp:Label ID="lblMemIdError" ForeColor="Red" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblMemIdSuccess" ForeColor="Green" runat="server" Text=""></asp:Label>
