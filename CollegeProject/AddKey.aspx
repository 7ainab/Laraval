<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddKey.aspx.cs" Inherits="CollegeProject.AddKey" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <asp:Label ID="Label1" runat="server" Text="Label" BackColor="#c0c0c0" ForeColor="#ffffff" Font-Size="30px" Width="1250px">Add New Key</asp:Label>
            ...
            <asp:Table ID="Table1" runat="server" Height="309px" Width="434px" BackColor="">
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <asp:TextBox ID="TextBoxkeyNum" class="form-control" OnTextChanged="TextBoxkeyNum_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox><asp:Label ID="KeyNumberMsg" ForeColor="Red" runat="server" Text=""></asp:Label>
